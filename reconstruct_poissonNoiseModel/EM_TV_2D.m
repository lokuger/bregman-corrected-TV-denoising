function u = EM_TV_2D(g, mu, omega, maxEMIts, tol)
...
u = mean(g)*ones(M*N,1); p = zeros(M*N,1);
k = 0;
stopcrit = false;
while ~stopcrit
    ...
    [unew,pnew] = ROFdenoise_weighted_2D(ukhalf_damp, u, omega*mu, M, N);
